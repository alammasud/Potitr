...
// fprintf(fp,"%s","pair_coeff      * * /home/masud/job/potentials/library_latticename.meam latticename NULL latticename\n");
//fprintf(fp,"%s","pair_style      meam\n");
...
//  fprintf(fp,"pair_coeff      * *  /Users/masud/MD/potentials/library_%s.meam %s /Users/masud/MD/potentials/%s.meam  %s\n",ch1,ch,ch,ch);
  ...
  fprintf(fp,"%s", "minimize        1.0e-8 1.0e-8 100000 1000000\n");
