...
unit [1][0]=0.5*a;unit [1][1]=0.5*a;unit [1][2]=0;
unit [2][0]=0.5*a;unit [2][1]=0;unit [2][2]=0.5*a;
unit [3][0]=0;unit [3][1]=0.5*a;unit [3][2]=0.5*a;
unit [4][0]=0.25*a;unit [4][1]=0.25*a;unit [4][2]=0.25*a;
unit [5][0]=0.75*a;unit [5][1]=0.75*a;unit [5][2]=0.25*a;
unit [6][0]=0.75*a;unit [6][1]=0.25*a;unit [6][2]=0.75*a;
unit [7][0]=0.25*a;unit [7][1]=0.75*a;unit [7][2]=0.75*a;
